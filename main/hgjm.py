...
def get_batch_specs(TargetThroughput) -> dict:
    ...
    NumberOfNodes = 4 if NodeThroughput < MaxThroughputPerNode else math.floor(TargetThroughput/NodeThroughput) #default the number of nodes to 4
    ...
    MinNodeThroughput = math.floor(int(TargetThroughput) / (NumberOfNodes))
    MaxNodeThroughput = math.ceil(int(TargetThroughput) / (NumberOfNodes))
...
if __name__ == '__main__':
    ...
    TargetThroughput = 2000 #100001 #thoughput messages/sec
